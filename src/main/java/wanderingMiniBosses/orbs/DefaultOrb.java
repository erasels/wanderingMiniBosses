package wanderingMiniBosses.orbs;
...
import static wanderingMiniBosses.WanderingminibossesMod.makeOrbPath;

public class DefaultOrb extends AbstractOrb {

    // Standard ID/Description
    public static final String ORB_ID = WanderingminibossesMod.makeID("DefaultOrb");
