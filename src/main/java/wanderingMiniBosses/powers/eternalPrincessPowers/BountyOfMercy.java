...
public class BountyOfMercy extends AbstractPower {

    public static final String POWER_ID = WanderingminibossesMod.makeID("BountyOfMercy");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;
    public static final int BOUNTY = 100;
    ...
    public BountyOfMercy(AbstractCreature owner) {
        name = NAME;
        ID = POWER_ID;
