...
public class HoverTopCard {
    ...
    {
        if (__instance.hoveredCard.equals(UpdateAndTrackTopCard.Fields.currentCard.get(__instance.drawPile)))
        {
    ...
    public static class NoPush
    {
        ...
        {
            if (c.equals(UpdateAndTrackTopCard.Fields.currentCard.get(AbstractDungeon.player.drawPile)))
            {
