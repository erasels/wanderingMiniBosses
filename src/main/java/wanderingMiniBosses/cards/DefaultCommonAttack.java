...
public class DefaultCommonAttack extends CustomCard {
    ...
    public static final String ID = WanderingminibossesMod.makeID(DefaultCommonAttack.class.getSimpleName());
    ...
    // The list of all of them can be found in the main WanderingminibossesMod.java file in the
    ...
    // Go check out DefaultAttackWithVariable and wanderingMiniBosses.variable.DefaultCustomVariable
