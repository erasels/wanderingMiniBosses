package wanderingMiniBosses.variables;

import basemod.abstracts.DynamicVariable;
import com.megacrit.cardcrawl.cards.AbstractCard;
import wanderingMiniBosses.cards.AbstractDefaultCard;

import static wanderingMiniBosses.WanderingminibossesMod.makeID;
...
public class DefaultSecondMagicNumber extends DynamicVariable {
    ...
    public String key() {
        ...
        // Remember, we're using makeID so it automatically puts "wanderingMiniBosses:" (or, your id) before the name.
    }
