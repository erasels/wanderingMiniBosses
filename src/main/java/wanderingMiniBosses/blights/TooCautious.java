...
public class TooCautious extends AbstractBlight implements CustomSavable<ArrayList<Integer>> {
	...
	public static final String TOO_CAUTIOUS_SAVE_FIELD_KEY =
			"wandering_mini_bosses_too_cautious_data";
